...
# BRINDA
	...
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
	VALUES ('BC1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04')), 'Turista',  100.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
	VALUES ('BC1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04')), 'Primera',  200.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('BC1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04')), 'Ejecutiva', 300.00, 2);	
	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
	VALUES ('BC2', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02')), 'Turista',  100.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
	VALUES ('BC2', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02')), 'Primera',  200.00, 3);	
		
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
	VALUES ('BC2', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-05')), 'Turista',  100.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('BC2', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-05')), 'Primera',  200.00, 3);	
	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('CB1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02')), 'Turista',  100.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('CB1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02')), 'Primera',  200.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('CB1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02')), 'Ejecutiva', 300.00, 2);	
	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('CB1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04')), 'Turista',  100.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('CB1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04')), 'Primera',  200.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('CB1', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04')), 'Ejecutiva', 300.00, 2);	
	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('CB2', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02')), 'Turista',  100.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('CB2', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02')), 'Primera',  200.00, 3);	
	...
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('BM', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03')), 'Turista',  100.00, 3);	
	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('BM', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-07')), 'Turista',  100.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
	VALUES ('BM', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-07')), 'Primera',  200.00, 3);	
	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
	VALUES ('MB', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03')), 'Turista',  100.00, 3);	
	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos)
	VALUES ('MB', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-07')), 'Turista',  100.00, 3);	
	INSERT INTO brinda(vuelo, dia, clase, precio, cant_asientos) 
	VALUES ('MB', dia(CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-07')), 'Primera',  200.00, 3);	
...
# ASIENTOS_RESERVADOS
        ...
        # cantidad de asientos reservados del vuelo BC1 del 201X-01-02
	...
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BC1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Ejecutiva', 0);	
	
		# cantidad de asientos reservados del vuelo BC1 del 201X-01-04	
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BC1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04'), 'Turista', 0);
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BC1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04'), 'Primera', 0);		
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BC1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04'), 'Ejecutiva', 0);	
		
		# cantidad de asientos reservados del vuelo BC2 del 201X-01-02
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BC2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Turista', 0);
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BC2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Primera', 0);	
		
		# cantidad de asientos reservados del vuelo BC2 del 201X-01-05
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BC2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-05'), 'Turista', 0);
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BC2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-05'), 'Primera', 0);	
		
		
		# cantidad de asientos reservados del vuelo CB1 del 201X-01-02	
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Turista', 0);
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Primera', 0);		
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Ejecutiva', 0);
		
		
		# cantidad de asientos reservados del vuelo CB1 del 201X-01-04	
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04'), 'Turista', 0);
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04'), 'Primera', 0);		
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB1', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-04'), 'Ejecutiva', 0);	
		
		
		# cantidad de asientos reservados del vuelo CB2 del 201X-01-02
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Turista', 0);
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-02'), 'Primera', 0);
		

        # cantidad de asientos reservados del vuelo CB2 del 201X-01-05
    INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-05'), 'Turista', 4);
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('CB2', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-05'), 'Primera', 1);
		
		
		# cantidad de asientos reservados del vuelo BM del 201X-01-03
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BM', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03'), 'Turista', 0);	
	
		# cantidad de asientos reservados del vuelo BM del 201X-01-07
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BM', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-07'), 'Turista', 0);		
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('BM', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-07'), 'Primera', 0);	
		
		# cantidad de asientos reservados del vuelo BM del 201X-01-03
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('MB', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-03'), 'Turista', 0);	
	
	# cantidad de asientos reservados del vuelo BM del 201X-01-07
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('MB', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-07'), 'Turista', 0);		
	INSERT INTO asientos_reservados(vuelo, fecha, clase, cantidad) 
        VALUES ('MB', CONCAT(YEAR(DATE_ADD(NOW(), INTERVAL 1 YEAR)),'-01-07'), 'Primera', 0);
